...
| --- | --- |
| Product Owner decision for AC-01 through AC-06 | Defines canonical aggregate and ownership boundaries. |
...
| --- | --- | --- | --- |
| 3.1 Scope foundation | Organization, Workspace, Repository, Project ownership model and scope-aware authorization contracts | AC-03 / ADR-035 | No customer migration or external tenant onboarding without scope approval. |
...
| 3.6 Localization foundation | Canonical English representations and versioned localized representations for approved object types | AC-05 | No automatic translation of source evidence. |
...
- Every durable canonical object is scope-bound and has a named lifecycle authority.
...
- Treating a physical execution workspace as the logical Workspace scope.
